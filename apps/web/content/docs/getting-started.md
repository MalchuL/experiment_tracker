...
Open **Projects** from the sidebar or the top navigation to see every project you can access. Create a project from the workspace view, then open it to manage experiments, metrics, and more.
...
- [Domains](/docs/domains) — users, teams, projects, experiments, scalars, metrics, artifacts, and reports.
